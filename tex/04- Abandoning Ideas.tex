...
The goal here is not to avoid being wrong. That would be both impossible and extremely boring. The goal is to be wrong in ways that sharpen your understanding, to fail usefully, to let the bad ideas die without dragging you down with them.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{xkcd/securityAdvice}
    \caption{\textbf{\href{https://www.explainxkcd.com/wiki/index.php/1820:_Security_Advice}{1820: Security Advice}}}
\end{figure}